                    ...
                    fetch('get_campuses.php')
                        .then(response => {
                            if (!response.ok) {
                                ...
                                return {
                                    ...
                                    campuses: ['Central', 'Alangilan', 'Lemery', 'Lipa', 'Balayan', 'Lobo', 'Mabini', 'Malvar', 'Nasugbu', 'Pablo Borbon', 'Rosario', 'San Juan']
                                };
                            }
                        ...
                        .then(data => {
                            ...
                            const campusList = (data.success && Array.isArray(data.campuses)) ?
                                data.campuses : ['Central', 'Alangilan', 'Lemery', 'Lipa', 'Balayan', 'Lobo', 'Mabini', 'Malvar', 'Nasugbu', 'Pablo Borbon', 'Rosario', 'San Juan'];
                        ...
                        .catch(error => {
                            ...
                            const defaultCampuses = ['Central', 'Main Campus', 'Alangilan', 'Lemery', 'Lipa', 'Balayan', 'Lobo', 'Mabini', 'Malvar', 'Nasugbu', 'Pablo Borbon', 'Rosario', 'San Juan'];
