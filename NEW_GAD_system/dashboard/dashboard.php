...
<body class="<?php echo $isCentral ? 'isCentral' : ''; ?>">
    ...
    <div class="main-content">
        ...
        // Get actual budget usage: approved_budget from ppas_forms, ps_attribution from narrative_entries
        if ($isCentral) {
            ...
            $psAttributionQuery = "SELECT SUM(CAST(ps_attribution AS DECIMAL(15,2))) as total_ps_attribution FROM narrative_entries WHERE year = '$currentYear' AND campus = '$userCampus'";
        }
