        ...
        function displayReport(data, budgetData) {
            ...
            if (!data || data.length === 0) {
                ...
                html += `
                    ...
                    <tr>
                        <td colspan="3" style="font-size: 10px; padding: 2px;">
                            <p style="font-size: 10px; margin-bottom: 2px;"><strong>Prepared by:</strong></p>
                            <div style="text-align: center; margin-top: 20px;">
                                <p style="font-size: 10px; margin-bottom: 0; text-decoration: underline;">RICHELLE M. SULIT</p>
                                <p style="font-size: 10px; margin-top: 0;">GAD Head Secretariat</p>
                            </div>
                        </td>
                        <td colspan="4" style="font-size: 10px; padding: 2px;">
                            <p style="font-size: 10px; margin-bottom: 2px;"><strong>Approved by:</strong></p>
                            <div style="text-align: center; margin-top: 20px;">
                                <p style="font-size: 10px; margin-bottom: 0; text-decoration: underline;">ATTY. ALVIN R. DE SILVA</p>
                                <p style="font-size: 10px; margin-top: 0;">Chancellor</p>
                            </div>
                        </td>
                        <td colspan="2" style="font-size: 10px; padding: 2px;">
                            <p style="font-size: 10px; margin-bottom: 2px;"><strong>Date</strong></p>
                            <p style="font-size: 10px; margin-top: 20px;">${new Date().toLocaleDateString('en-US', { day: 'numeric', month: 'long', year: 'numeric' })}</p>
                        </td>
                    </tr>
                `;
            }
