...
try {
        ...
        'data' => array(
            ...
            'sections' => array(
                ...
                'participants' => array(
                    ...
                    'internal_type' => safe_get($proposal, 'internal_type', 'Internal Participants'),
    ...
    if ($wordFormat) {
        ...
        $html .= '<td style="border:solid black 1.0pt; mso-border-alt:solid black 1.0pt; padding:5.0pt;">';
        $html .= '<strong>Internal Type:</strong> ' . htmlspecialchars($sections['participants']['internal_type'] ?? 'Internal Participants') . '<br>';
